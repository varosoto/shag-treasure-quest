...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "13 challenges through the Seaholm district. Presented by Shag Salon Austin — where hair matters." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@shagaustin" },
      { name: "twitter:title", content: "SHAG × Seaholm Scavenger Hunt" },
      { name: "twitter:description", content: "13 challenges through the Seaholm district. Presented by Shag Salon Austin." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,700;1,700&family=DM+Sans:wght@300;400;500;700&family=DM+Mono:wght@400;500&display=swap" },
